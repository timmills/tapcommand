...
enum opt_code
{
  ...
  OPT_mextra_l32r_costs_ = 1598,             /* -mextra-l32r-costs= */
  OPT_mforce_l32 = 1599,                     /* -mforce-l32 */
  OPT_mforce_no_pic = 1600,                  /* -mforce-no-pic */
  /* OPT_mfused_madd = 1601, */              /* -mfused-madd */
  OPT_mlongcalls = 1602,                     /* -mlongcalls */
  OPT_mserialize_volatile = 1603,            /* -mserialize-volatile */
  OPT_mtarget_align = 1604,                  /* -mtarget-align */
  OPT_mtext_section_literals = 1605,         /* -mtext-section-literals */
  OPT_n = 1606,                              /* -n */
  ...
  OPT_r = 1641,                              /* -r */
  OPT_rdynamic = 1642,                       /* -rdynamic */
  OPT_remap = 1643,                          /* -remap */
  OPT_reverse_sort = 1644,                   /* -reverse-sort */
  OPT_s = 1645,                              /* -s */
  OPT_save_temps = 1646,                     /* -save-temps */
  OPT_save_temps_ = 1647,                    /* -save-temps= */
  OPT_shared = 1648,                         /* -shared */
  OPT_shared_libgcc = 1649,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1650,               /* -shared-libphobos */
  OPT_size_sort = 1651,                      /* -size-sort */
  /* OPT_specs = 1652, */                    /* -specs */
  OPT_specs_ = 1653,                         /* -specs= */
  OPT_static = 1654,                         /* -static */
  OPT_static_libasan = 1655,                 /* -static-libasan */
  OPT_static_libgcc = 1656,                  /* -static-libgcc */
  OPT_static_libgfortran = 1657,             /* -static-libgfortran */
  OPT_static_libgo = 1658,                   /* -static-libgo */
  OPT_static_liblsan = 1659,                 /* -static-liblsan */
  OPT_static_libmpx = 1660,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1661,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1662,               /* -static-libphobos */
  OPT_static_libstdc__ = 1663,               /* -static-libstdc++ */
  OPT_static_libtsan = 1664,                 /* -static-libtsan */
  OPT_static_libubsan = 1665,                /* -static-libubsan */
  OPT_static_pie = 1666,                     /* -static-pie */
  /* OPT_std_c__03 = 1667, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1668, */                /* -std=c++0x */
  OPT_std_c__11 = 1669,                      /* -std=c++11 */
  OPT_std_c__14 = 1670,                      /* -std=c++14 */
  OPT_std_c__17 = 1671,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1672, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1673, */                /* -std=c++1z */
  /* OPT_std_c__20 = 1674, */                /* -std=c++20 */
  OPT_std_c__2a = 1675,                      /* -std=c++2a */
  OPT_std_c__98 = 1676,                      /* -std=c++98 */
  OPT_std_c11 = 1677,                        /* -std=c11 */
  OPT_std_c17 = 1678,                        /* -std=c17 */
  /* OPT_std_c18 = 1679, */                  /* -std=c18 */
  /* OPT_std_c1x = 1680, */                  /* -std=c1x */
  OPT_std_c2x = 1681,                        /* -std=c2x */
  /* OPT_std_c89 = 1682, */                  /* -std=c89 */
  OPT_std_c90 = 1683,                        /* -std=c90 */
  OPT_std_c99 = 1684,                        /* -std=c99 */
  /* OPT_std_c9x = 1685, */                  /* -std=c9x */
  OPT_std_f2003 = 1686,                      /* -std=f2003 */
  OPT_std_f2008 = 1687,                      /* -std=f2008 */
  OPT_std_f2008ts = 1688,                    /* -std=f2008ts */
  OPT_std_f2018 = 1689,                      /* -std=f2018 */
  OPT_std_f95 = 1690,                        /* -std=f95 */
  OPT_std_gnu = 1691,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1692, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1693, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1694,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1695,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1696,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1697, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1698, */              /* -std=gnu++1z */
  /* OPT_std_gnu__20 = 1699, */              /* -std=gnu++20 */
  OPT_std_gnu__2a = 1700,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1701,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1702,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1703,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1704, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1705, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1706,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1707, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1708,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1709,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1710, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1711, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1712,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1713, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1714, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1715, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1716, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1717, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1718,                     /* -std=legacy */
  OPT_symbol_ = 1719,                        /* -symbol= */
  OPT_symbolic = 1720,                       /* -symbolic */
  OPT_t = 1721,                              /* -t */
  OPT_time = 1722,                           /* -time */
  OPT_time_ = 1723,                          /* -time= */
  OPT_traditional = 1724,                    /* -traditional */
  OPT_traditional_cpp = 1725,                /* -traditional-cpp */
  OPT_tree_stats = 1726,                     /* -tree-stats */
  OPT_trigraphs = 1727,                      /* -trigraphs */
  OPT_type_stats = 1728,                     /* -type-stats */
  OPT_u = 1729,                              /* -u */
  OPT_undef = 1730,                          /* -undef */
  OPT_v = 1731,                              /* -v */
  OPT_version = 1732,                        /* -version */
  OPT_w = 1733,                              /* -w */
  OPT_wrapper = 1734,                        /* -wrapper */
  OPT_x = 1735,                              /* -x */
  OPT_z = 1736,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
