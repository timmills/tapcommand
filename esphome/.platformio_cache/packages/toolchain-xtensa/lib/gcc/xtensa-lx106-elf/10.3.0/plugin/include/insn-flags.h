...
static inline rtx gen_extvsi_internal          (rtx, rtx, rtx, rtx);
static inline rtx
gen_extvsi_internal(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
...
static inline rtx gen_extvsi                   (rtx, rtx, rtx, rtx);
static inline rtx
gen_extvsi(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
